...
const AddEC = (studentId) => {
    const createEC = trpc.ec.create.useMutation();
    ...
    const onCreateEC = handleSubmit((e) => {
        createEC.mutate({ name: e.ecName,
            phone: e.ecphone,
            email: e.ecemail,
            relationship: e.ecrelation,
    ...
    <div className="relative w-full h-full max-w-md md:h-auto">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="px-6 py-6 lg:px-8 ">
                ...
                <form className="space-y-3" onSubmit={onCreateEC}>
                    <div className="flex flex-row gap-2">
        <div>
        <label htmlFor="ecName" className="text-lg">EC Name</label>
        <input type="text" {...register("ecName", { required: true })} id="ecName" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:placeholder-gray-500 dark:focus:ring-blue-400 dark:focus:border-blue-400"/>
        </div>
        <div >
        <label htmlFor="ecphone" className="text-lg">EC phone</label>
        <input type="text" {...register("ecphone", { required: true })} id="ecphone" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:placeholder-gray-500 dark:focus:ring-blue-400 dark:focus:border-blue-400"/>
        </div>
        </div>
        <div className="flex flex-row  gap-2">
            <div>
        <label htmlFor="ecemail" className="text-lg">EC email</label>
        <input type="text" {...register("ecemail", { required: true })} id="ecemail" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:placeholder-gray-500 dark:focus:ring-blue-400 dark:focus:border-blue-400"/>
        </div>
        <div>
        <label htmlFor="ecrelation" className="text-lg">EC relation</label>
        <input type="text" {...register("ecrelation", { required: true })} id="ecrelation" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:placeholder-gray-500 dark:focus:ring-blue-400 dark:focus:border-blue-400"/>
        </div></div>
